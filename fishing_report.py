...
GEAR_CHECK = {
    "spin": [
        ...
        "#16 orthodontic rubber bands (¼ in dental elastics, ~$3 a bag of 100, not owned) — the breakaway sinker attachment for snaggy bottom; a wide office rubber band cut into ¼ in slices works in a pinch",
